  ...
  //Méthode Supression
    public  void supprimerStagiaire(String stagiaireASupprimer) {
    		...
    		private NoeudArbreBinaire supprimerRacine(NoeudArbreBinaire s) {
    			...
    			// 3ème cas : Le noeud à supprimer a un fils gauche et un fils droit, on recherche alors le noeud le plus à gauche, qui a donc la plus petite valeur
    			// de son sous-arbre droit, pour mettre cette valeur dans le noeud contenant celle à supprimer et qui sera donc écrasée
